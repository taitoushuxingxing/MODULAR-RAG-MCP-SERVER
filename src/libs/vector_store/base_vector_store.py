...
class BaseVectorStore(ABC):
    ...
    @abstractmethod
    def upset(self, records: List[Dict[str,Any]], trace: Optional[Any] = None, **kwargs: Any) -> None:
    ...
    @abstractmethod
    def query(self, vector: List[float], top_k = 10, filters: Optional[Dict[str,Any]] = None, trace: Optional[Any] = None, **kwargs:Any) -> List[Dict[str, Any]]:

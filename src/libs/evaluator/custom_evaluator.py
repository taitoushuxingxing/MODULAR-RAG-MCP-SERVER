...
class CustomEvaluator(BaseEvaluator):
    ...
    """    
    SUPPORTED_METRICS = {"hit_rate", "mmr"}                         # 集合,用于快速查找
    _ID_FIELDS = ("id", "chunk_id", "document_id", "doc_id")        #TUPLE（元组），不可变

    def __init__(self, settings: Any = None, metrics: Optional[Sequence[str]] = None, **kwargs: Any,) -> None:

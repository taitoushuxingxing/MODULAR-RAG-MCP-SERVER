...
class BaseEvaluator(ABC):
    ...
    @abstractmethod
    def evaluate(self, query: str, retrieved_chunks: List[Any], generated_answer: Optional[str] = None, ground_truth: Optional[Any] = None, trace: Optional[Any] = None,**kwargs: Any,
    ) -> Dict[str, float]:
...
class NoneEvaluator(BaseEvaluator):
    ...
    def evaluate(self, query: str, retrieved_chunks: List[Any], generated_answer: str | None = None, ground_truth: Any | None = None, trace: Any | None = None, **kwargs: Any) -> Dict[str, float]:

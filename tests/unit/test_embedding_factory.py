...
class TestEmbeddingFactory:
    ...
    def test_register_provider_success(self):
        ...
        EmbeddingFactory.registerProvider("fake", FakeEmbedding)
    ...
    def test_register_provider_case_insensitive(self):
        ...
        EmbeddingFactory.registerProvider("OpenAI", FakeEmbedding)
    ...
    def test_list_providers_empty(self):
        ...
        assert EmbeddingFactory.listProviders() == []
    
    def test_list_providers_sorted(self):
        """list_providers should return sorted provider names."""
        EmbeddingFactory.registerProvider("zebra", FakeEmbedding)
        EmbeddingFactory.registerProvider("alpha", FakeEmbedding)
        EmbeddingFactory.registerProvider("beta", FakeEmbedding)
        
        providers = EmbeddingFactory.listProviders()
    ...
    def test_create_provider_instantiation_failure(self):
        ...
        EmbeddingFactory.registerProvider("broken", BrokenEmbedding)
